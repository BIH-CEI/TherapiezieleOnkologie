# Therapieziel – Erhaltungstherapie / Stabilisierung (Beispiel) - Implementierungsleitfaden Therapieziele Onkologie v1.0.0-ballot-rc.1

## Beispiel Goal: Therapieziel – Erhaltungstherapie / Stabilisierung (Beispiel)
