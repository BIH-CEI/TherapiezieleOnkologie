# Tumorboard-Empfehlung – FOLFOX + Bevacizumab (Beispiel) - Implementierungsleitfaden Therapieziele Onkologie v1.0.0-ballot-rc.1

## Beispiel MedicationRequest: Tumorboard-Empfehlung – FOLFOX + Bevacizumab (Beispiel)
