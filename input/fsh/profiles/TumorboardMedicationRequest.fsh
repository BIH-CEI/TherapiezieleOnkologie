Profile: TumorboardMedicationRequest
...
"""
* insert Translation(^title, en, Tumor board medication request)
* insert Translation(^description, en, Structured tumor board recommendation based on MedicationRequest. The category must contain the LOINC code Tumor board Consult note 85232-7 to mark it as a tumor board recommendation.)
...
* medication[x] MS
* insert Label(medication[x], Medikation, Empfohlene Medikation bzw. Systemtherapie.)
* insert Translation(medication[x] ^short, en, Medication)
* insert Translation(medication[x] ^definition, en, Recommended medication or systemic therapy.)
