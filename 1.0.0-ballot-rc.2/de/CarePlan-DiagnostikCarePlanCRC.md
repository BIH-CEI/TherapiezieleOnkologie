# Diagnostischer CarePlan – Tumordiagnostik (Beispiel) - Implementierungsleitfaden Therapieziele Onkologie v1.0.0-ballot-rc.2

## Beispiel CarePlan: Diagnostischer CarePlan – Tumordiagnostik (Beispiel)
