# Onkologische Diagnose (Condition) - Implementierungsleitfaden Therapieziele Onkologie v1.0.0-ballot-rc.2

## Ressourcenprofil: Onkologische Diagnose (Condition) 
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-onko-condition.csv), [Excel](../StructureDefinition-onko-condition.xlsx), [Schematron](../StructureDefinition-onko-condition.sch) 
