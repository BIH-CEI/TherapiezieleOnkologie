# Diagnostischer CarePlan (Beispiel Mamma) - Implementierungsleitfaden Therapieziele Onkologie v1.0.0-ballot-rc.2

## Beispiel CarePlan: Diagnostischer CarePlan (Beispiel Mamma)
