# Zielarten → SNOMED CT (Zielzustände) - Implementierungsleitfaden Therapieziele Onkologie v1.0.0-ballot-rc.2

## ConceptMap: Zielarten → SNOMED CT (Zielzustände) (Experimentell) 
