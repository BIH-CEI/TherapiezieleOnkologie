# Stanzbiopsat Mamma links (Beispiel) - Implementierungsleitfaden Therapieziele Onkologie v1.0.0-ballot-rc.2

## Example Specimen: Stanzbiopsat Mamma links (Beispiel)
