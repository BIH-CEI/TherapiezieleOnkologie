# Anwendungsbeispiel (mCRC palliativ) - Implementierungsleitfaden Therapieziele Onkologie v1.0.0-ballot-rc.2
...
| Diagnostik-Plan | `DiagnosticCarePlan` | [DiagnostikCarePlanCRC](CarePlan-DiagnostikCarePlanCRC.md) |
