# Brusterhaltende Operation + Sentinel-Lymphknoten-Biopsie (Beispiel) - Implementierungsleitfaden Therapieziele Onkologie v1.0.0-ballot-rc.2

## Example Procedure: Brusterhaltende Operation + Sentinel-Lymphknoten-Biopsie (Beispiel)
