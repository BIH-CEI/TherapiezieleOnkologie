...
```json
{
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-enlist-line-segment.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/enlist-line-segment"
      },
      "name" : "EnLiST-Linien-Segment (Extension)",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-enlist-change.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/enlist-change"
      },
      "name" : "EnLiST-Änderungstyp (Extension)",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-TherapiezielDreieck.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/TherapiezielDreieck"
      },
      "name" : "Therapieziel-Dreieck (logisches Modell)",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ConceptMap-ConceptMapOnkoTherapyGoalTypeSct.html"
      }],
      "reference" : {
        "reference" : "ConceptMap/ConceptMapOnkoTherapyGoalTypeSct"
      },
      "name" : "Zielarten → SNOMED CT (Zielzustände)",
    ...
    "page" : {
      ...
      },
      {
        ...
        "title" : "Therapieziele (Goals)",
        "generation" : "markdown"
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "empfehlung-behandlung.html"
        }],
        "nameUrl" : "empfehlung-behandlung.html",
        "title" : "Empfehlungs- und Behandlungsplan",
        "generation" : "markdown"
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "behandlungsepisode.html"
        }],
        "nameUrl" : "behandlungsepisode.html",
        "title" : "Behandlungsepisoden (EpisodeOfCare)",
        "generation" : "markdown"
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "goal-target-measure.html"
        }],
        "nameUrl" : "goal-target-measure.html",
        "title" : "Zielwerte und Messgrößen",
        "generation" : "markdown"
      },
      {
        "extension" : [{
